  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.17);borderRadius:10px">
        <h1 class="h1" style="color:rgba(36, 194, 205, 1);fontSize:28px;">微信小程序家政项目小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="账号" class="input" v-if="tableName=='jiazhengrenyuan'">
			...
			<el-form-item label="电话" class="input" v-if="tableName=='jiazhengrenyuan'">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='jiazhengrenyuan'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱"  />
			</el-form-item>
