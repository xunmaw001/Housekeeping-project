<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="擅长" prop="shanzhang">
          <el-input v-model="ruleForm.shanzhang" 
              placeholder="擅长" clearable  :readonly="ro.shanzhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="擅长" prop="shanzhang">
              <el-input v-model="ruleForm.shanzhang" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="服务要求" prop="fuwuyaoqiu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="服务要求"
                  v-model="ruleForm.fuwuyaoqiu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.fuwuyaoqiu" label="服务要求" prop="fuwuyaoqiu">
                    <span>{{ruleForm.fuwuyaoqiu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
		...
		if(json.jiazhengxingming!=''&&json.jiazhengxingming){
