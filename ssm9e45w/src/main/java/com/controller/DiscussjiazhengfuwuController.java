...
public class DiscussjiazhengfuwuController {
    ...
    public R save(@RequestBody DiscussjiazhengfuwuEntity discussjiazhengfuwu, HttpServletRequest request){
    	discussjiazhengfuwu.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
    ...
    public R update(@RequestBody DiscussjiazhengfuwuEntity discussjiazhengfuwu, HttpServletRequest request){
        //ValidatorUtils.validateEntity(discussjiazhengfuwu);
        discussjiazhengfuwuService.updateById(discussjiazhengfuwu);//全部更新
        return R.ok();
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DiscussjiazhengfuwuEntity> wrapper = new EntityWrapper<DiscussjiazhengfuwuEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = discussjiazhengfuwuService.selectCount(wrapper);
